...
router.get('/:appId', asyncHandler(async function(req: any, res: any) {
...
router.patch('/:appId', asyncHandler(async function(req: any, res: any) {
...
router.delete('/:appId', asyncHandler(async function(req: any, res: any) {
